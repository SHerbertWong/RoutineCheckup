...
POWERSHELL -ExecutionPolicy Bypass -Command ^
	"Write-Host -Object 'Downloading %WgetFileName%... ' -NoNewline; (New-Object -TypeName Net.WebClient).DownloadFile(($env:WgetUri), (Join-Path -Path '%RoutineCheckupRootPath%' -ChildPath '%WgetFileName%')); Write-Host -Object 'Done!'"
POWERSHELL -ExecutionPolicy Bypass -Command ^
